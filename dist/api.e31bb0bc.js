...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"../../node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"ms":"../../node_modules/ms/index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./debug":"../../node_modules/debug/src/debug.js","process":"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js"}],"../../node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{}],"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/isarray/index.js":[function(require,module,exports) {
var toString = {}.toString;
...
},{"buffer":"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/buffer/index.js"}],"../../node_modules/socket.io-parser/binary.js":[function(require,module,exports) {
/*global Blob,File*/
...
},{"isarray":"../../node_modules/isarray/index.js","buffer":"../../../../AppData/Roaming/npm/node_modules/parcel/node_modules/buffer/index.js"}],"../../node_modules/arraybuffer.slice/index.js":[function(require,module,exports) {
/**
...
},{"./polling":"../../node_modules/engine.io-client/lib/transports/polling.js","component-inherit":"../../node_modules/component-inherit/index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/_empty.js":[function(require,module,exports) {
...
},{"./url":"../../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../../node_modules/socket.io-parser/index.js","./manager":"../../node_modules/socket.io-client/lib/manager.js","debug":"../../node_modules/debug/src/browser.js","./socket":"../../node_modules/socket.io-client/lib/socket.js"}],"../../lib/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.debugPanel = exports.d = exports.get = void 0;
...
var d = function d(type) {
  ...
  if (args.length === 1) {
    return console[type].apply(_this, args);
  }
...
},{"./config":"../../lib/config.js"}],"../../lib/config.js":[function(require,module,exports) {
"use strict";
...
},{"./utils":"../../lib/utils.js"}],"../../lib/socket.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Socket(parent) {
    ...
    if (!_config.default.get('socket')) {
      return parent._event.emit('loaded');
    }

    this.socket = (0, _socket.default)(_config.default.get('path'));
  ...
  _createClass(Socket, [{
    ...
    value: function setup() {
      ...
      var tokenHandler = _config.default.get('tokenHandler');

      var token = tokenHandler.get('token');

      if (token) {
        (0, _utils.d)('info', 'Authenticating socket.');
        this.socket.emit('login', token);
      }

      this.socket.on('reconnect', function () {
        (0, _utils.d)('info', 'Socket has reconnected');

        _this.socket.emit('login', token);
      });
      this.socket.on('login', function () {
        (0, _utils.d)('info', 'Socket has logged in');
      });
...
},{"socket.io-client":"../../node_modules/socket.io-client/lib/index.js","./config":"../../lib/config.js","./utils":"../../lib/utils.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../lib/actions.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Actions, [{
    ...
    value: function makeHttpClient() {
      ...
      var options = {
        baseURL: _config.default.get('path')
      };
      ...
      var client = _axios.default.create(options);

      var onAuthFailed = function onAuthFailed() {
        _this.parent._auth.logout();

        var fn = _config.default.get('authFailed');
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  (0, _utils.d)('info', 'Attempting token refresh');
                  _context.next = 6;
                ...
                case 12:
                   ...
                   * Update the tokens
                   */
                  (0, _utils.d)('info', 'Successfully refreshed token, retrying request.');
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (_config.default.get('actions')) {
                  _context3.next = 3;
                  break;
                }
              ...
              case 3:
                ...
                _context3.prev = 4;
                _context3.next = 7;
                return http.get(_config.default.get('actions'));
              ...
              case 12:
                ...
                (0, _utils.d)('error', 'Could not load actions list.');
              ...
              case 16:
                ...
                _loop = function _loop(key) {
                  ...
                  if (_this2.hasOwnProperty(key)) {
                    (0, _utils.d)('warn', "Could not register ".concat(key, " as it is already being used."));
                    return "continue";
                  }
                      ...
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              tokenHandler = _config.default.get('tokenHandler');
                              _context2.next = 3;
                            ...
                            case 3:
                              ...
                              if (key === 'login' && data.token) {
                                ...
                                if (_config.default.get('refresh')) {
                                  tokenHandler.set('refresh', data.refresh);
                                }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                start = +new Date();
                (0, _utils.d)('info', "Doing action ".concat(action, ", sent payload:"), payload);
                /**
              ...
              case 7:
                ...
                (0, _utils.d)('info', "Local validation failed for ".concat(action, ", errors:"), errors);
              ...
              case 13:
                _context4.prev = 13;
                _context4.next = 16;
                return this.parent.http.post(_config.default.get('handler'), [action, payload]);
              ...
              case 21:
                ...
                _errors = (0, _utils.get)(_context4.t0, 'response.data.errors', false);
              ...
              case 25:
                ...
                (0, _utils.d)('info', "Finished doing action [".concat(action, "] in [").concat(end - start, " ms], result:"), result);
                return _context4.abrupt("return", result);
...
Actions.actions = {};
},{"./config":"../../lib/config.js","axios":"../../node_modules/axios/index.js","./utils":"../../lib/utils.js"}],"../../lib/auth.js":[function(require,module,exports) {
"use strict";
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return this.parent.login(_objectSpread({}, payload, {
                  refresh: _config.default.get('refresh') ? 1 : 0
                }));
      ...
      regeneratorRuntime.mark(function _callee3() {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                (0, _utils.d)('info', 'Attempting to logout');
                tokenHandler = _config.default.get('tokenHandler');
                _context3.next = 4;
              ...
              case 4:
                ...
                tokenHandler.remove('token');
                tokenHandler.remove('refresh');
                (0, _utils.d)('info', 'User has logout');
...
},{"./utils":"../../lib/utils.js","./config":"../../lib/config.js"}],"../../lib/event.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Event, [{
    ...
    value: function on(event, listener) {
      ...
      (0, _utils.d)('info', "Registering event ".concat(event));
      return function () {
    ...
    value: function emit(event) {
      ...
      if (_typeof(this.events[event]) === 'object') {
        this.events[event].forEach(function (listener) {
          (0, _utils.d)('info', "Calling event [".concat(event, "], payload:"), args);
...
},{"./utils":"../../lib/utils.js"}],"../../lib/validator.js":[function(require,module,exports) {
"use strict";
...
var _socket = _interopRequireDefault(require("./lib/socket"));

var _actions = _interopRequireDefault(require("./lib/actions"));
...
function () {
  function Serpent(path) {
    ...
    _config.default.store(this.opts);
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this._event = new _event.default();
                ...
                this._actions = new _actions.default(this);
                new _socket.default(this);
                this._validator = new _validator.default();
                this._utils = Utils;
                this._config = _config.default;
...
Serpent.actions = {};
},{"./lib/socket":"../../lib/socket.js","./lib/actions":"../../lib/actions.js","./lib/config":"../../lib/config.js","./lib/auth":"../../lib/auth.js","./lib/event":"../../lib/event.js","./lib/validator":"../../lib/validator.js","./lib/utils":"../../lib/utils.js"}],"client.js":[function(require,module,exports) {
"use strict";
 ...
 * Export the client
 */
var _default = new _index.default('http://localhost:3000', {
  socket: true,
  debug: true,
  refresh: true
});
...
window.client = _client.default;
var _client$_utils = _client.default._utils,
    d = _client$_utils.d,
    debugPanel = _client$_utils.debugPanel;

_client.default.ready(
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
regeneratorRuntime.mark(function _callee2() {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return _context.abrupt("return", d('info', 'Already logged in'));

                  case 2:
                    d('info', 'Logging in.');
                    _context.next = 5;
                    return _client.default._auth.login({
                      provider: 'local',
                      email: 'me@me.com',
                      password: 'password'
                    });
                  ...
                  case 5:
                    ...
                    return _context.abrupt("return", d('error', 'Error', errors));
...
debugPanel();
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./client":"client.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13355" + '/');
...
//# sourceMappingURL=/api.e31bb0bc.js.map