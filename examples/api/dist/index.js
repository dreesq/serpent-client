...
var d = function d() {
  ...
  return console.log.apply(_this, ['(serpent)'].concat(args));
};
...
function () {
  ...
  _createClass(Socket, [{
    ...
    value: function setup() {
      ...
      var token = _config.default.get('tokenHandler').get();

      if (token) {
        (0, _utils.d)('Authenticating socket.');
        this.socket.emit('login', token);
      }

      this.socket.on('reconnect', function () {
        (0, _utils.d)('Socket has reconnected.');

        _this.socket.emit('login', token);
      });
      this.socket.on('login', function () {
        (0, _utils.d)('Socket has logged in.');
      });
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3() {
        ...
        var http, _ref3, data, _loop, key, _ret;
              ...
              case 5:
                ...
                _loop = function _loop(key) {
                  ...
                  if (_this2.hasOwnProperty(key)) {
                    (0, _utils.d)("Could not register ".concat(key, " as it is already being used."));
                    return "continue";
                  }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                (0, _utils.d)('Doing action', action, 'payload', payload);
                /**
              ...
              case 6:
                ...
                (0, _utils.d)('Local validation failed for', action, 'errors', errors);
              ...
              case 12:
                _context4.prev = 12;
                (0, _utils.d)('Sending payload to server for action', action);
                _context4.next = 16;
              ...
              case 16:
                ...
                data = _ref6.data;
                (0, _utils.d)('Server response for action', action, ':', data);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                data = _ref.data;
                errors = _ref.errors;
                (0, _utils.d)('User has attempted authenticating', data, errors);
              ...
              case 10:
                ...
                (0, _utils.d)('Errors while retrieving user', errors);
                return _context.abrupt("return", {
                  data: user.data,
                  errors: user.errors
                });
              ...
              case 14:
                this.user = user.data;
                (0, _utils.d)('User has authenticated', this.user);
                return _context.abrupt("return", {
                  data: this.user,
                  errors: false
                });
      ...
      regeneratorRuntime.mark(function _callee3() {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                (0, _utils.d)('Attempting to logout');
                tokenHandler = _config.default.get('tokenHandler');
                _context3.next = 4;
...
function () {
  ...
  _createClass(Event, [{
    ...
    value: function on(event, listener) {
      ...
      (0, _utils.d)('Registering event', event);
      return function () {
    ...
    value: function emit(event) {
      ...
      if (_typeof(this.events[event]) === 'object') {
        this.events[event].forEach(function (listener) {
          (0, _utils.d)('Calling event ', event, 'arguments', args);
 ...
 * Export the client
 */
var _default = new _index.default('http://localhost:3004', {
  socket: true,
  debug: true
});
...
var d = _client.default._utils.d;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return _context.abrupt("return", d('Already logged in'));

                  case 2:
                    d('Logging in.');
                    _context.next = 5;
                    return _client.default.login({
                      provider: 'local',
                      email: 'mail@mail.com',
                      password: 'password'
                    });
                  ...
                  case 5:
                    ...
                    return _context.abrupt("return", d('Error', errors));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5143" + '/');
